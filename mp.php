...
<body>
    <div class="fixed-header">
      ...
      <li><i class="glyphicon glyphicon-shopping-cart" style="color:white"><a href="cart.html" class="nav-link" style="color:black">CART</a></i></li>
      <li><i class="glyphicon glyphicon-bell" style="color:white"></i></li>
      <li><i class="glyphicon glyphicon-user" style="color:white">
        <?php
...
<center>
  ...
  <button   class="w3-button w3-border-red w3-round-large w3-hover-red" style="color:red"><a  href="#" style="text-decoration:none"><b></b></a></button><button class="w3-button w3-border-red w3-round-large w3-hover-red" style="color:red"><a  data-toggle="modal" href="#myModal2" style="text-decoration:none"></a></button></div></div><br><br>
